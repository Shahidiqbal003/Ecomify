...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/login', [AuthController::class, 'index'])->name('super_admin.login')->middleware('guest');
...
Route::group(['prefix' => '{shop}/store', 'middleware' => 'identify.shop'], function () {
...
Route::group(['prefix' => '{shop}/admin', 'middleware' => 'identify.shop'], function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/settings/pages', [StoreSettingController::class, 'pages'])->name('settings.pages');
