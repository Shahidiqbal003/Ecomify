      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route('collection.index', ['shop' => request()->route('shop')]) }}">Collections</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <form class="needs-validation" novalidate action="{{ route('collection.store', ['shop' => request()->route('shop')]) }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Collection Name" value="{{old('name')}}" required>
                      @error('name')
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <textarea name="note" id="note" class="form-control @error('note') is-invalid @enderror" cols="10" rows="5" placeholder="Collection Note">{{old('note')}}</textarea>
                      @error('note')
                      <span class="invalid-feedback text-danger">{{ $message }}</span>
                      @enderror
                  ...
                  <div class="col-lg-6">
                     ...
                     <div id="imagePreview" style="margin-top: 10px;">
                        <img id="preview" src="" class="img-thumbnail" alt="Image preview" style="max-width: 168px;max-height: 200px;display: none;margin: right;">
                    </div>
                  </div>
                </div>
              </div>
